...
//import com.android.example.github.databinding.;

public class MoviesFilterFragment extends DialogFragment {
    ...
    public static MoviesFilterFragment newInstance(MovieListFragment movieListFragment) {
        MoviesFilterFragment dialog = new MoviesFilterFragment();
    ...
    private void init() {
        rootView = LayoutInflater.from(getContext())
                .inflate(R.layout.movies_filter_fragment, null, false);
